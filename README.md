...
![X8 Results](Figures/x8-facial.png)

---

4× Face Super-Resolution (32 → 128)

![X4 Results](Figures/x4.png)

---
4x Face Super resolution with crop facial features

![X4 Results](Figures/x4-facial.png)

---

## SwinIFS: Google drive link (Our results)

These are the resulte for 4x (upscaling):

-**https://drive.google.com/drive/folders/1A4gJzkjmkvlK3R_gf-r7ApUw6C1K6H_q?usp=sharing**

These are the resulte for 8x (upscaling):
...
## 🚀 Training
4× Super-Resolution
- **python train_evaluate_swinfsr.py --opt option/swinifsr/train_swinifsr_x4.json**

8× Super-Resolution
- **python train_evaluate_swinfsr.py --opt option/swinifsr/train_swinifsr-x8.json**
